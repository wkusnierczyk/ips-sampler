...
def main():
    ...
    # Required
    parser.add_argument("-s", "--samples", type=int, required=True, help="Number of samples to generate")
    
    # Optional
    parser.add_argument("-o", "--output-dir", type=str, default="output", help="Directory to save JSON files")
    parser.add_argument("-c", "--config", type=str, default="config/ips_config.json", help="Path to JSON configuration file")
    parser.add_argument("--seed", type=int, help="Random seed for reproducibility")
    parser.add_argument("--minify", action="store_true", help="Output minified JSON (no indentation)")
