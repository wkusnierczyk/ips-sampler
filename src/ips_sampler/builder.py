...
class IPSBuilder:
    ...
    def add_condition(self):
        ...
        self._ensure_section("Problem List", self.config["terminologies"]["loinc"]["problems"], f"Condition/{res_id}")
        return self
    ...
    def add_medication(self):
        ...
        self._ensure_section("Medication Summary", self.config["terminologies"]["loinc"]["medications"], f"MedicationStatement/{res_id}")
        return self
    ...
    def add_allergy(self):
        ...
        self._ensure_section("Allergies", self.config["terminologies"]["loinc"]["allergies"], f"AllergyIntolerance/{res_id}")
        return self
